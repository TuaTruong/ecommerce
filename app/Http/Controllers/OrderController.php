...
class OrderController extends Controller
{
    ...
    <table class="table-styling">
        ...
        foreach($order_details as $ord){
            $output.='
                <tr>
                    ...
                    <td>'.number_format($ord->product_quantity * $ord->product_price,0,",",".").' VND</td>
                </tr>
            ';
        ...
        if($coupon){
            if($coupon->condition == 0){
                ...
                <tr>
                    ...
                    <td></td>
                    <td>Giảm giá</td>
                    <td>'.number_format($coupon->discount,0,",",".").'VND</td>
                </tr>
                ';
        ...
        <tr>
            ...
            <td></td>
            <td>Phí ship</td>
            <td>'.number_format($order_details[0]->feeship,0,",",".").'VND</td>
        </tr>
        ';
