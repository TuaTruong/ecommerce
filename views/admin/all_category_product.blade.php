                    ...
                    <tbody>
                        @foreach ($all_category_product as $cate_pro)
                            <tr>
                                ...
                                <td>13.12.2023</td>
                                <td>
                                    <a href="/edit-category-product/{{ $cate_pro->id }}" class="active"
                                        ui-toggle-class=""><i
                                            class="fa fa-pencil-square-o text-success text-active"></i></a>
                                    <a href="/delete-category-product/{{ $cate_pro->id }}" onclick="return confirm('Bạn có chắc là muốn xóa danh mục này không?')">
