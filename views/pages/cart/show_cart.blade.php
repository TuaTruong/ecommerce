<x-layout :categories="$categories" :brands="$brands">
                        ...
                        @foreach ($content as $v_content)
                            <tr>
                                <td class="cart_product">
                                    <a href=""><img src="upload/product/{{$v_content->options->image}}" width="50" alt=""></a>
                                </td>
                                ...
                                <td class="cart_total">
                                    <p class="cart_total_price">{{number_format($v_content->qty * $v_content->price)}} VND</p>
                                </td>
